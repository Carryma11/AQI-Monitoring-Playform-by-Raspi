 ...
 *
 * This is a modified version of jQuery v2.0.3
 * with a backported fix for https://github.com/jquery/jquery/issues/2432
 * It was generated as follows (after backporting):
 *
 *   ./node_modules/.bin/uglifyjs -cm --comments -- ./bower_components/jquery/jquery.js
 *
 * @preserve
 */
